...
export default function HeroSection() {
  return (
    <section className="w-full bg-background px-6 pt-10 pb-16">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-start gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="relative w-full max-w-lg lg:max-w-xl">
            <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-xl shadow-eulah/10">
              ...
              <div className="space-y-4 p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-3 w-11/12 rounded bg-red-100 dark:bg-red-900/30" />
                  <div className="h-3 w-10/12 rounded bg-red-100 dark:bg-red-900/30" />
                  <div className="h-3 w-full rounded bg-border" />
                </div>
